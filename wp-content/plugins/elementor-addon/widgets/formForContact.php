...
class Elementor_formForContact extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        <style>
            ...
            .<?php echo esc_attr($widget_id); ?> .cfl-image {
                margin-bottom: 30px;
                background-color: #f0f0f0;
            }
            .<?php echo esc_attr($widget_id); ?> .cfl-image img {
                width: 100%;
                height: auto;
                display: block;
            }
        ...
        <div class="<?php echo esc_attr($widget_id); ?>">
            ...
            <div class="cfl-main-content">
                <div class="cfl-left-col">
                    <?php if (!empty($settings['left_column_image']['url'])) : ?>
                        <div class="cfl-image">
                            <img src="<?php echo esc_url($settings['left_column_image']['url']); ?>" alt="">
                        </div>
                    <?php endif; ?>
                    <div class="cfl-contact-details">
                        <div class="cfl-detail-item">
                            <h4>Phone</h4>
                            <p><a href="tel:<?php echo esc_attr(preg_replace('/[^\d+]/', '', $settings['phone'])); ?>"><?php echo esc_html($settings['phone']); ?></a></p>
                        </div>
                        <div class="cfl-detail-item">
                            <h4>Email</h4>
                        ...
                        <div class="cfl-detail-item">
                            ...
                            <div class="cfl-social-icons">
                                <?php foreach ($settings['social_links_list'] as $item) : ?>
                                    <a href="<?php echo esc_url($item['social_link']['url']); ?>" class="cfl-social-icon-link" <?php if($item['social_link']['is_external']) { echo 'target="_blank" rel="noopener noreferrer"'; } ?>>
